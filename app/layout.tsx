...
export const metadata: Metadata = {
  ...
  description: "Pasta Famiglia — це автентичний італійський ресторан у центрі Києва, що пропонує домашню пасту ручної роботи та піцу з дров’яної печі для молодих сімей та ",
  openGraph: { title: "Pasta Famiglia", description: "Pasta Famiglia — це автентичний італійський ресторан у центрі Києва, що пропонує домашню пасту ручної роботи та піцу з дров’яної печі для молодих сімей та ", type: "website" },
};
