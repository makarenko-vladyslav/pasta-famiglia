...
export const metadata: Metadata = {
  ...
  description: "Pasta Famiglia — це автентичний італійський ресторан у центрі Києва, створений для сімейних обідів та швидких бізнес-ланчів, де акцент зроблено на домашній",
  openGraph: { title: "Pasta Famiglia", description: "Pasta Famiglia — це автентичний італійський ресторан у центрі Києва, створений для сімейних обідів та швидких бізнес-ланчів, де акцент зроблено на домашній", type: "website" },
};
