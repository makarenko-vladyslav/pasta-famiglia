...
export const metadata: Metadata = {
  ...
  description: "Pasta Famiglia — це автентичний італійський ресторан у центрі Києва, який поєднує затишок сімейних вечерь із власною свіжою пастою та швидкими бізнес-ланча",
  openGraph: { title: "Pasta Famiglia", description: "Pasta Famiglia — це автентичний італійський ресторан у центрі Києва, який поєднує затишок сімейних вечерь із власною свіжою пастою та швидкими бізнес-ланча", type: "website" },
};
  ...
  return (
    <html lang="uk">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@500;700;800&family=Lora:wght@400;500&display=swap" rel="stylesheet" />
