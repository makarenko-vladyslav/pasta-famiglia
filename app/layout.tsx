...
export const metadata: Metadata = {
  ...
  description: "Pasta Famiglia — це сімейний італійський ресторан у центрі Києва, що пропонує автентичну свіжу пасту ручної роботи та піцу з дров’яної печі для молодих сім",
  openGraph: { title: "Pasta Famiglia", description: "Pasta Famiglia — це сімейний італійський ресторан у центрі Києва, що пропонує автентичну свіжу пасту ручної роботи та піцу з дров’яної печі для молодих сім", type: "website" },
};
  ...
  return (
    <html lang="uk">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@500;700;800&family=Lora:wght@400;600&display=swap" rel="stylesheet" />
