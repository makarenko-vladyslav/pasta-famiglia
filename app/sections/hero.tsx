...
export function SectionHero() {
  const headline = "Свіжа паста за 20 хвилин";
  ...
  return (
    <section id="hero" className="relative min-h-[100svh] overflow-hidden bg-foreground text-background">
      ...
      <img 
        src="https://images.pexels.com/photos/5953526/pexels-photo-5953526.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200" 
        alt="Свіжа італійська паста ручної роботи Pasta Famiglia" 
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-[92rem] flex-col justify-end px-4 pb-28 lg:px-10 lg:pb-16">
        ...
        <h1 className="font-display font-extrabold leading-[0.88] text-background [text-wrap:balance] text-[clamp(3.2rem,11vw,10rem)] max-w-[12ch]">
          {words.map((word, i) => (
            <span 
              key={i} 
              className="word-rise inline-block whitespace-nowrap" 
        ...
        <div className="mt-8 flex flex-wrap items-end justify-between gap-6">
          <Reveal delay={0.4}>
            <p className="max-w-md text-base leading-relaxed text-background/80 font-light">
              Готуємо на Антоновича: власна паста Semola та піца з печі у центрі Києва.
            </p>
          </Reveal>
