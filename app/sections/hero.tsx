      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-[92rem] flex-col justify-end px-4 pb-28 lg:px-10 lg:pb-16">
        ...
        <Reveal delay={0.2}>
          <div className="mb-3 flex flex-wrap items-center gap-x-3 gap-y-1 text-sm text-background/75">
            ...
            <span className="hidden sm:inline">ВУЛ. ХРЕЩАТИК</span>
          </div>
        </Reveal>
        ...
        <div className="mt-8 flex flex-wrap items-end justify-between gap-6">
          <Reveal delay={0.4}>
            <p className="max-w-md text-base leading-relaxed text-background/80 lg:text-lg">
              Готуємо пасту ручної роботи та класичні антипасті за родинними рецептами у самому центрі столиці. Вечори італійської кухні кожного дня.
            </p>
          </Reveal>
