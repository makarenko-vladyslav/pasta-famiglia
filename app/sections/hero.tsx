...
/**
 * ACT I: The Arrival.
 * Establishes the 'Heart of the Home' positioning through a dark, immersive atmosphere.
 * Layout adheres strictly to the Award-winning Skeleton provided.
 */
export function SectionHero() {
  const h1Words = ["Дім", "Свіжої", "Пасти", "У", "Києві"];
  const marqueeItems = [
    "PASTA FRESCA",
    "КИЇВ",
    "VINO ITALIANO",
  ...
  return (
    <section id="hero" className="relative min-h-[100svh] overflow-hidden bg-foreground text-background">
      ...
      <img 
        src="https://images.pexels.com/photos/29626982/pexels-photo-29626982.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200" 
        alt="Інтер'єр італійського ресторану Pasta Famiglia" 
        ...
        <div className="mt-8 flex flex-wrap items-end justify-between gap-6">
          <Reveal delay={0.5}>
            <p className="max-w-md text-base leading-relaxed text-background/80">
              Власне виробництво пасти щоранку в самому центрі столиці. Відкрита кухня, локальні інгредієнти та рецепти італійських родин.
            </p>
          </Reveal>
          ...
          <Reveal delay={0.6}>
            <Magnetic>
              ...
              >
                Замовити стіл <span aria-hidden className="text-xl">→</span>
              </a>
            </Magnetic>
          </Reveal>
        </div>
