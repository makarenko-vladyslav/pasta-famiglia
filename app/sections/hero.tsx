...
export function SectionHero() {
  const h1Words = ["СІМЕЙНА", "ПАСТА,", "ЩО", "ЄДНАЄ", "СЕРЦЯ"];
  const marqueeItems = [
    "СВІЖА ПАСТА",
    "ТРАДИЦІЙНІ РЕЦЕПТИ",
    "ІТАЛІЙСЬКІ ВИНА",
  ...
  return (
    <section id="hero" className="relative min-h-[100svh] overflow-hidden bg-foreground text-background">
      ...
      <img 
        src="https://images.pexels.com/photos/6933769/pexels-photo-6933769.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200" 
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-[92rem] flex-col justify-end px-4 pb-28 lg:px-10 lg:pb-16">
        ...
        <h1 className="font-display font-extrabold leading-[0.88] tracking-[-0.055em] text-background [text-wrap:balance] text-[clamp(3.2rem,11vw,10rem)] max-w-[12ch]">
          {h1Words.map((word, i) => (
            <span 
              key={i} 
        ...
        <div className="mt-8 flex flex-wrap items-end justify-between gap-6">
          <Reveal delay={0.4}>
            <p className="max-w-md text-base leading-relaxed text-background/80">
              Відкрийте справжню Італію в самому центрі столиці. Рецепти, що передаються поколіннями, 
              та атмосфера, де кожен гість стає частиною нашої великої родини.
            </p>
          </Reveal>
