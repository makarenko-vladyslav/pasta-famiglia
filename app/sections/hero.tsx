...
export function SectionHero() {
  const headlineWords = "Свіжа паста за 20 хвилин".split(" ");
  ...
  return (
    <section id="hero" className="relative min-h-[100svh] overflow-hidden bg-foreground text-background">
      ...
      <img 
        ...
        alt="Pasta Famiglia - Свіжа паста за 20 хвилин" 
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-[92rem] flex-col justify-end px-4 pb-28 lg:px-10 lg:pb-16">
        ...
        <h1 className="font-display font-extrabold text-background [text-wrap:balance] text-[clamp(3.2rem,11vw,10rem)] max-w-[12ch] leading-[0.95] tracking-[-0.05em]">
        ...
        <div className="mt-8 flex flex-wrap items-end justify-between gap-6">
          <Reveal delay={0.6}>
            <p className="max-w-md text-base lg:text-lg leading-relaxed text-background/80 font-body">
              Готуємо з борошна Semola на відкритій кухні в центрі Києва. Без прихованих зборів за сервіс у чеку.
            </p>
          </Reveal>
