  ...
  const menuItems = [
    {
      ...
      desc: "Домашні спагеті, хрусткий гуанчале, жовток фермерського яйця та витриманий пекоріно романо.",
      price: "245 ₴",
      photo: "https://images.pexels.com/photos/32872507/pexels-photo-32872507.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=1200&w=800"
    },
    {
      name: "Тальятеле з білими грибами",
      desc: "Широка локшина власного приготування з обсмаженими карпатськими грибами у вершковому соусі.",
      price: "290 ₴",
      photo: "https://images.pexels.com/photos/32872507/pexels-photo-32872507.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=1200&w=800"
    },
    {
      name: "Папарделле з качиним рагу",
      desc: "Томлене філе качки з овочевим софрітто, червоним вином та свіжим чебрецем.",
      price: "320 ₴",
      photo: "https://images.pexels.com/photos/32872507/pexels-photo-32872507.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=1200&w=800"
    },
    {
      name: "Спагеті з морепродуктами",
      desc: "Тигрові креветки, мідії та кальмари у пікантному томатному соусі з базиліком.",
      price: "385 ₴",
      photo: "https://images.pexels.com/photos/32872507/pexels-photo-32872507.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=1200&w=800"
    },
    {
      name: "Равіолі з рикотою та шпинатом",
      desc: "Тонке тісто, ніжна начинка з італійської рикоти та молодий шпинат під шафрановим соусом.",
      price: "215 ₴",
      photo: "https://images.pexels.com/photos/32872507/pexels-photo-32872507.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=1200&w=800"
    }
  ];
          ...
          <div className="lg:sticky lg:top-28 lg:self-start">
            ...
            <Reveal delay={0.12}>
              <p className="mt-6 max-w-sm text-base leading-relaxed text-muted">
                Ми готуємо нашу пасту щодня вручну, використовуючи лише італійське борошно з твердих сортів пшениці та добірні фермерські інгредієнти.
              </p>
            </Reveal>
            <Reveal delay={0.2}>
